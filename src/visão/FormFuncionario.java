...
public class FormFuncionario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CadastroDeFuncionario.setText("Cadastro de Funcionário");
        getContentPane().add(CadastroDeFuncionario);
        CadastroDeFuncionario.setBounds(132, 11, 421, 43);
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        try {
            modeloFuncionario funcionarios = new modeloFuncionario(nome, datadenascimento, rg, orgao, cpf, email, telefone, cep, uf, cidade, bairro , rua, numero, complemento );
            ConexaoBD conecta_funcionario = new ConexaoBD();
            conecta_funcionario.CadastrarFuncionario(funcionarios);
