 ...
 * @author CASA
 */
public class TelaPesFuncionario extends javax.swing.JFrame {
    ConexaoBD conex = new ConexaoBD();
    /**
     * Creates new form TelaPesFuncionario
     */
    public TelaPesFuncionario() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pesquisar e Atulizar Funcionários");
    ...
    private void jButtonPesIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPesIdActionPerformed
        ...
        try{
            ...
            funcionario.setId(Integer.parseInt(campoid.getText()));
            ConexaoBD conexao = new ConexaoBD();
            funcionario = conexao.ProcurarFuncionario(funcionario.getId());
        
            if (funcionario.getId() != 0) {
                campoNome.setText(funcionario.getNome());
                campoDataDeNascimento.setText(funcionario.getDatadenascimento());
                campoRG.setText(funcionario.getRg());
                campoOrgao.setText(funcionario.getOrgao());
                ...
                campoComplemento.setText(funcionario.getComplemento());
    ...
    private void jButtonExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonExcluirActionPerformed
        try {
            ...
            conecta_funcionario.RemoverFuncionario(id);
            campoid.setText("");
            campoNome.setText("");
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        try{
            ...
            modeloFuncionario funcionarios = new modeloFuncionario(id, nome, datadenascimento, rg, orgao, cpf, email, telefone, cep, uf, cidade, bairro, rua, numero, complemento);
            ConexaoBD conecta_funcionario = new ConexaoBD();
            conecta_funcionario.AtualizarFuncionario(funcionarios, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPesFuncionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPesFuncionario().setVisible(true);
            }
        });
    }
